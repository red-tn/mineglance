...
const PLAN_INFO: Record<UpgradePlan, {
  ...
  annual: {
    ...
    description: 'Enter code STAY10 at checkout'
  },
  lifetime: {
    price: 9900,
    ...
    description: 'Enter code STAY25 at checkout'
  },
  monthly: {
    price: 699,
    label: 'Monthly Plan',
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-dark-text-muted mt-1">Enter code STAY25 at checkout</p>
                      </div>
                      <div className="text-right">

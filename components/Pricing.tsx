            ...
            >
              ...
              <div className="text-center mb-8">
                ...
                <div className="mt-4">
                  ...
                  <span className={`text-lg ${plan.popular ? 'text-white/70' : 'text-foreground/60'}`}>
                    {' '}{plan.period}
                  </span>
                </div>
                <p className={`mt-2 ${plan.popular ? 'text-white/70' : 'text-foreground/60'}`}>
                  {plan.description}
                </p>
              </div>
              ...
              <CTAButton
                ...
                className={`w-full ${plan.popular ? 'bg-accent hover:bg-green-600' : ''}`}
              >
                {plan.cta}
              </CTAButton>
            </div>

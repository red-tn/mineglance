        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 max-w-5xl mx-auto">
            ...
            <div className="glass-card rounded-2xl p-6 sm:p-8">
              ...
              <Link
                href="/download"
                className="w-full text-center justify-center inline-flex items-center gap-2 px-6 py-3 bg-dark-card-hover hover:bg-dark-border text-dark-text font-semibold rounded-lg transition-all"
              >
                Install Free
              </Link>
            </div>
          ...
          <div className="mt-12 sm:mt-16">
            ...
            <div className="flex flex-wrap justify-center gap-4 sm:gap-6">
              ...
              <Link
                href="/download"
                className="flex items-center gap-3 px-5 py-3 rounded-xl glass-card hover:border-primary/50 transition-colors cursor-pointer"
              >
              ...
              >
                ...
                <span className="font-semibold text-dark-text">Windows</span>
              </Link>
              ...
              >
                ...
                <span className="font-semibold text-dark-text">macOS</span>
              </Link>
            </div>
          </div>

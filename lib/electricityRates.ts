...
// Data from EIA (U.S. Energy Information Administration) - 2024 averages

// Average electricity rates by state (USD/kWh)
...
export interface ElectricityLookupResult {
  rate: number
  state: string
  stateName: string
}
...
/**
 * Look up electricity rate by ZIP code
 * @param zip - US ZIP code (5 digits)
 * @returns Rate info or null if not found
 */
export function lookupElectricityRate(zip: string): ElectricityLookupResult | null {
  // Clean and validate ZIP
...
/**
 * Default US average electricity rate
 */
export const DEFAULT_RATE = 0.12 // US average $/kWh

/**
 * Get default US average rate
 */

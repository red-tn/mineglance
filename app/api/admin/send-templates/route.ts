      ...
      <table width="600" cellpadding="0" cellspacing="0" style="background-color: #141414; border-radius: 16px; border: 1px solid #2d2d2d;">
        ...
        <tr><td style="padding: 20px 40px;">
          ...
          <div style="background: rgba(251, 191, 36, 0.1); border: 1px solid rgba(251, 191, 36, 0.3); border-radius: 12px; padding: 20px; text-align: center; margin: 20px 0;">
            <p style="color: #fbbf24; margin: 0 0 10px; font-size: 14px; font-weight: 600;">Loyalty Discount: MINE26</p>
            <p style="color: #9ca3af; margin: 0; font-size: 13px;">Use code <strong style="color: #fbbf24;">MINE26</strong> for 10% off your renewal ($53/year)</p>
          </div>

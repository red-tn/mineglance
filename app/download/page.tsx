    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <header className="sticky top-0 z-50 bg-black/80 backdrop-blur border-b border-white/10">
        <nav className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2 font-bold text-lg">
            <Image src="/logo-icon.svg" alt="MineGlance" width={32} height={32} className="w-8 h-8" />
            MineGlance
          </Link>
      ...
      <section className="max-w-6xl mx-auto px-4 py-16 text-center">
        <h1 className="text-4xl md:text-6xl font-bold mb-6">
          Download <span className="text-green-400">MineGlance</span>
        </h1>
      ...
      <section className="max-w-6xl mx-auto px-4 py-12">
        <div className="bg-gradient-to-br from-green-500/10 to-transparent border border-green-500/30 rounded-3xl p-8 md:p-12">
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="flex-1">
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 px-8 py-4 bg-green-600 hover:bg-green-500 rounded-xl font-bold transition w-full md:w-auto"
              >
                <Download size={20} />
              ...
              <div className="flex flex-wrap items-center gap-4 mt-6">
                ...
                {/* Chrome */}
                <button onClick={() => setShowExtensionModal(true)} className="flex items-center gap-2 text-gray-400 hover:text-white transition">
            ...
            <div className="flex-shrink-0">
              <div className="w-48 h-48 bg-gradient-to-br from-green-500/20 to-green-500/5 rounded-3xl flex items-center justify-center">
          ...
          <div className="grid md:grid-cols-3 gap-4 mt-8 pt-8 border-t border-white/10">
            {extensionFeatures.map((feature, i) => (
              <div key={i} className="flex items-start gap-3">
                <feature.icon className="text-green-400 flex-shrink-0 mt-1" size={20} />
                <div>
      ...
      {/* Desktop App Section */}
      <section className="max-w-6xl mx-auto px-4 py-12">
        <div className="bg-gradient-to-br from-blue-500/10 to-transparent border border-blue-500/30 rounded-3xl p-8 md:p-12">
          <div className="text-center mb-8">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-blue-500/20 rounded-full text-blue-400 text-sm mb-4">
              <Monitor size={14} />
              Desktop App
            </div>
            <h2 className="text-3xl font-bold mb-4">Desktop Application</h2>
          ...
          <div className="flex flex-col md:flex-row gap-6 justify-center mb-8">
            {/* Windows Download */}
            <div className="bg-zinc-900/50 border border-zinc-800 rounded-2xl p-6 min-w-[280px]">
          ...
          {/* Desktop Features */}
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 pt-8 border-t border-white/10">
            {desktopFeatures.map((feature, i) => (
              <div key={i} className="flex items-start gap-3 bg-zinc-900/30 rounded-xl p-4">
      ...
      <section className="max-w-6xl mx-auto px-4 py-16">
        <h2 className="text-2xl font-bold text-center mb-8">Works On All Major Platforms</h2>
        <div className="flex flex-wrap justify-center gap-8">
          {/* Browsers */}
          <div className="flex items-center gap-4 px-6 py-3 bg-zinc-900/50 rounded-xl">
          ...
          <div className="flex items-center gap-4 px-6 py-3 bg-zinc-900/50 rounded-xl">
            ...
            <span className="text-gray-300">Brave</span>
          </div>
          <div className="flex items-center gap-4 px-6 py-3 bg-zinc-900/50 rounded-xl">
            ...
            <span className="text-gray-300">Opera</span>
          </div>
          {/* Desktop */}
          <div className="flex items-center gap-4 px-6 py-3 bg-zinc-900/50 rounded-xl">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="font-bold text-lg">Browser Extension</h3>
            </div>

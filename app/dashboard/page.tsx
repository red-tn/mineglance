    ...
    try {
      ...
      if (res.ok) {
        ...
        if (data.version && data.downloadUrl) {
          ...
          setExtensionRelease({ version: data.version, downloadUrl: data.downloadUrl, fileName })
        }
      }
    } catch (e) {
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          ...
          {windowsRelease ? (
            <a
              href={windowsRelease.downloadUrl}
              download
              className="flex flex-col items-center p-4 bg-dark-card-hover rounded-lg hover:bg-sky-500/10 hover:border-sky-500/30 transition-colors group border border-transparent relative"
            >
              <span className="absolute top-2 right-2 text-[10px] bg-sky-500/20 text-sky-400 px-1.5 py-0.5 rounded-full font-medium">
          ...
          {macosRelease ? (
            <a
              href={macosRelease.downloadUrl}
              download
              className="flex flex-col items-center p-4 bg-dark-card-hover rounded-lg hover:bg-gray-500/10 hover:border-gray-500/30 transition-colors group border border-transparent relative"
            >
              <span className="absolute top-2 right-2 text-[10px] bg-gray-500/20 text-gray-300 px-1.5 py-0.5 rounded-full font-medium">

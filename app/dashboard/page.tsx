...
export default function DashboardOverview() {
  ...
  return (
    <div className="space-y-6">
        ...
        <Link href="/dashboard/devices" className="block">
          <div className="glass-card rounded-xl p-6 hover:border-primary/50 transition-colors border border-dark-border">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm text-dark-text-muted">Active Devices</p>
        ...
        <div className="glass-card rounded-xl p-6 border border-dark-border">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              <p className="text-sm text-dark-text-muted">License Key</p>
      ...
      <div className="glass-card rounded-xl border border-amber-500/30 p-6 bg-gradient-to-r from-amber-500/10 to-orange-500/10">
        <div className="flex items-start gap-4">
          ...
          <div>
            <h3 className="font-semibold text-dark-text">Mobile App Coming Soon</h3>

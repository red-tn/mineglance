                      ...
                      <tr key={post.id} className="border-b border-dark-border/50 hover:bg-dark-card/50">
                        ...
                        <td className="px-4 py-3">
                          <button
                            ...
                            title={post.status === 'scheduled' && post.scheduled_at ? `Scheduled: ${new Date(post.scheduled_at).toLocaleString()}` : undefined}
          ...
          <div className="min-h-full flex items-start sm:items-center justify-center p-2 sm:p-4">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-dark-text-muted text-sm mb-1">
                    Schedule For {form.status !== 'scheduled' && <span className="text-dark-text-dim">(optional)</span>}
                  </label>
                  <input
                    type="datetime-local"
                  ...
                  <div className="flex gap-2 mt-2">
                    <button
                      ...
                      onClick={() => {
                        ...
                        setForm({ ...form, scheduled_at: d.toISOString().slice(0, 16), status: 'scheduled' })
                      }}

        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="glass-card rounded-xl p-8 border border-dark-border text-center">
              ...
              <h3 className="text-lg font-semibold text-dark-text mb-2">Join Our Discord</h3>
              <p className="text-dark-text-muted mb-4 text-sm">
            ...
            <div className="glass-card rounded-xl p-8 border border-dark-border text-center">
              ...
              <h3 className="text-lg font-semibold text-dark-text mb-2">Email Support</h3>
              <p className="text-dark-text-muted mb-4 text-sm">
